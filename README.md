...
> **Status: scaffolding.** The repository structure, build, signing, and test
> harness are in place; the shelf itself is not implemented yet. See
> [docs/en/url-shelf-rfp.md](docs/en/url-shelf-rfp.md) for the full design.
